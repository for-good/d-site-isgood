...
1. Checkout this project repo and confirm the path is in Docker's file sharing config - https://docs.docker.com/docker-for-mac/#file-sharing
    ...
    ```bash
    git clone https://github.com/lagoon-examples/d-site-isgood.git d-site-isgood && cd $_
    ```
...
4. Visit the new site @ `http://d-site-isgood.docker.amazee.io`
...
6. Visit the new site @ `http://d-site-isgood.lndo.site`
